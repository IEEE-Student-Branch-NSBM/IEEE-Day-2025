  ...
  const testimonials = [
    {
      ...
      name: "Vinudi Sethna",
      description:
        '"Volunteering for IEEE Day 2019 and PES Day 2020 was wonderful - gained knowledge and great friends."',
    },
    {
      id: 2,
      name: "Denver Shenal",
      description:
        '"IEEE was a turning point in my life, providing constant learning and lifelong connections."',
    },
    {
      id: 3,
      name: "Pasan Jayawickrama",
      description:
        '"IEEE NSBM gave me valuable experiences, skills, and the chance to work with amazing people."',
    },
    {
      id: 4,
      name: "Sunali Rambukwella",
      description:
        '"IEEE NSBM became my university family - facing challenges together made us united."',
    },
    {
      id: 5,
      name: "Shameera Carrim",
      description:
        '"A motivating team that inspires juniors to excel in community volunteering and tech connections."',
    },
    {
      id: 6,
      name: "Yasmitha Peththanayake",
      description:
        '"I was lucky enough to interact with seniors to get a professional experience."',
    },
    {
      id: 7,
  ...
  return (
    ...
    >
      ...
      {testimonials.map((testimonial, index) => (
        ...
        >
          <div className="text-center font-semibold sm:font-semibold md:font-bold text-base sm:text-base md:text-xl mb-1 sm:mb-1 md:mb-2">
            {testimonial.name}
          </div>
          <div className="text-center text-sm sm:text-sm md:text-lg">
