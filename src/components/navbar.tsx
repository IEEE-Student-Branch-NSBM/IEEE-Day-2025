...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <div
        className={`block sm:block md:hidden fixed top-0 left-1/2 -translate-x-1/2 z-100 h-10 bg-white/5 backdrop-blur-lg transition-all duration-500 text-white ${isExpanded ? "h-screen w-screen" : "w-10"}`}
