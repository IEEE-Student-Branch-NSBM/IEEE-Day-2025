    ...
    const contactInfo = [
        {
            ...
            isLink: true,
            icon: (
                <svg className="fill-white h-4 md:h-8 w-4 md:w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3ZM12.0606 11.6829L5.64722 6.2377L4.35278 7.7623L12.0731 14.3171L19.6544 7.75616L18.3456 6.24384L12.0606 11.6829Z"></path></svg>
            )
        },
        {
            label: "Website",
        ...
        },
        {
            ...
            isLink: true,
            icon: (
                <svg className="fill-white h-4 md:h-8 w-4 md:w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M18.364 17.364L12 23.7279L5.63604 17.364C2.12132 13.8492 2.12132 8.15076 5.63604 4.63604C9.15076 1.12132 14.8492 1.12132 18.364 4.63604C21.8787 8.15076 21.8787 13.8492 18.364 17.364ZM12 15C14.2091 15 16 13.2091 16 11C16 8.79086 14.2091 7 12 7C9.79086 7 8 8.79086 8 11C8 13.2091 9.79086 15 12 15ZM12 13C10.8954 13 10 12.1046 10 11C10 9.89543 10.8954 9 12 9C13.1046 9 14 9.89543 14 11C14 12.1046 13.1046 13 12 13Z"></path></svg>
            )
        }
    ];

    return (
        <footer className="relative z-50 w-full h-auto bg-black text-white backdrop-blur-lg overflow-hidden py-2">
            <div className="container mx-auto">
                <div className="p-6 md:p-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-10 mb-10">
                        <div className="flex flex-col items-center justify-center space-y-4">
                            <div className="flex items-center mb-2">
                                <Image
                                    ...
                                    width={200}
                                    height={200}
                                    className="object-contain scale-60 md:scale-100 w-auto"
                                />
                            </div>
                            <div className="text-white/80 text-sm md:text-base leading-relaxed text-center max-w-md">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {socialLinks.map((social, index) => (
                                    <a
                                        key={index}
                                        href={social.url}
                                        className="w-8 h-8 flex items-center justify-center hover:scale-110 transition-transform duration-500"
                                    >
                                        {social.icon}
                                    </a>
                                ))}
                            ...
                            <div className="space-y-3">
                                {contactInfo.map((contact, index) => (
                                    <div key={index} className="flex items-start">
                                        <div className="mr-3 mt-0.5 p-1.5 flex items-center justify-center">
                                            {contact.icon}
                                        </div>
                                        <div>
                                            <div className="text-white/80 text-xs md:text-sm">{contact.label}</div>
                                            {contact.isLink ? (
                                                <a
                                                    href={contact.href}
                    ...
                    <div className="pt-8 border-t border-white/10">
                        <div className="grid grid-cols-1 sm:grid-cols-3 items-center justify-items-center h-full">
                            {chapterLogos.map((logo, index) => (
                                <div key={index}>
                                    <Image
                                        ...
                                        width={400}
                                        height={400}
                                        className="object-cover scale-50 md:scale-75"
                                    />
                                </div>
                            ))}
                        </div>
