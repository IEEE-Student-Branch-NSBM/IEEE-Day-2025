  ...
  try {
    ...
    const completion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are a helpful assistant for IEEE Day 2025 at NSBM Green University. 
...
- If the question is not related to IEEE Day 2025, politely redirect to IEEE Day topics
